...
# 2. Crie um programa que lê valores inteiros e, em seguida, mostre na tela os valores lidos.
print("\n" + "=" * 50)
print("EXERCÍCIO 2")
print("=" * 50)
numeros = []

quantidade = input("Digite a quantidade de números que você deseja digitar: ")

while not quantidade.isdigit():
    print("Você deve digitar apenas um número INTEIRO.")
    quantidade = input("Digite novamente a quantidade: ")
